...
use WarsztatyBundle\Entity\Email;
...
class EmailController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $emails = $em->getRepository('WarsztatyBundle:Email')->findAll();
    ...
    {
        $email = new Email();
        $form = $this->createForm('WarsztatyBundle\Form\EmailType', $email);
    ...
    {
        $deleteForm = $this->createDeleteForm($email);
        $editForm = $this->createForm('WarsztatyBundle\Form\EmailType', $email);
